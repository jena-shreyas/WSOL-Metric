...
def create_annot_csv(dataset_path: str):
    ...
    file_name = dataset_path + "/annotations_ft.csv"
...
def compute_and_save_embeddings(model, inp_path : str, out_path : str, device_ids: list):
...
def stylianou(model, img1_path: str, img2_path: str, save_path: str, device_ids: list): 
    ...
    features1 = model(img1_norm.unsqueeze(0))
    features2 = model(img2_norm.unsqueeze(0))
